...
$this->menu=array(
	...
	array('label'=>'更新','url'=>array('update','id'=>$model->uid),'icon'=>'pencil'),
	array('label'=>'删除','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->uid),'confirm'=>'真的要删除这条数据?'),'icon'=>'trash'),
